...
class groupContactForm(Form):
    group_name = TextField("团体名称",[validators.Required("Please enter your grouo_name.")])
    name=TextField("负责人姓名",[validators.Required("Please enter your name.")])
    cellphone = TextField("负责人手机号",[validators.Required("Please enter your cellphone.")])
    ...
    time = SelectField(
        ...
        choices=[('1', '9:00-9:30'), ('2', '9:30-10:00'), ('3', '10:00-10:30'), ('4', '10:30-11:00'), ('5', '14:00-14:30'), ('6', '14:30-15:00'), ('7', '15:00-15:30'), ('8', '15:30-16:00')],
        default = 8,
        coerce=int
    )
